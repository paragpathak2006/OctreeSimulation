...
MyDistanceFunction = @(QP, Direction) DistanceFunction_Quadrant([QP(1) QP(2)], FBeta, Direction, yFun);
...
%FName = 'NonConvex_Final_Order_Of_Convergence.xls';
FName = 'Quadrant_Final_Order_Of_Convergence.xls';
